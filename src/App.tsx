        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Unlock your potential with expert-led courses in technology, business, arts, and more. It's a vibrant community for exchanging ideas and fostering skills at any level. Join Swiftqueue to unlock your potential and embark on a journey of personal and professional development.
            </p>
